...
\item Détail d'une chaine Twitch
\end{itemize}
La liste des streams en ligne affiche les streams que l'utilisateur suit et qui sont actuellement en ligne, c'est-à-dire que la chaîne diffuse du flux vidéo.\\
La liste des streams hors-ligne affiche les streams que l'utilisateur suit et qui sont actuellement hors-ligne. Les différentes options de configuration de chaque stream sont accessible depuis ces liste. \\
...
L'ajout se fait également dans le compte Twitch de l'utilisateur connecté, il aura une chaîne en plus dans ça liste de suivis.
...
\subsubsection{Vérification de nouveaux streams en ligne}
